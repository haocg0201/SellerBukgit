...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        // Thiết lập dữ liệu cho từng item
...
//            holder.txtGiamSoLuong.setVisibility(View.INVISIBLE);
//        }else holder.txtGiamSoLuong.setVisibility(View.VISIBLE);
...
//                    .load("file://" + imagePath)
                ...
                btnXNMua.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        HoaDon hoaDon = new HoaDon(
                                // chưa lấy được mã nhân viên từ đăng nhập
                                1,
    ...
    public void reload(){
        itemList.clear();
        // thay ma nv
        itemList.addAll(ghDAO.getAllGioHangByMaNV(""));
        notifyDataSetChanged();
    }
